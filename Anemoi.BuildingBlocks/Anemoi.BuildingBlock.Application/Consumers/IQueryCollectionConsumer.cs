...
public interface IQueryCollectionConsumer<in TRequest, TResponse> : IConsumer<TRequest>
    where TRequest : class, IQueryCollection<TResponse> where TResponse : class
{
